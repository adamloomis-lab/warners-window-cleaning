...
export default function Footer() {
  return (
    <footer className="bg-[#0F2D4A] text-white relative overflow-hidden">
        ...
        <div className="grid sm:grid-cols-2 lg:grid-cols-4 gap-10">
          ...
          <div className="sm:col-span-2 lg:col-span-1">
            ...
            <a
              ...
              className="inline-flex items-center gap-2 px-4 py-2 bg-white/10 rounded-lg hover:bg-[#4A90D9]/30 transition-all duration-300 text-white/80 hover:text-white text-sm"
            >
