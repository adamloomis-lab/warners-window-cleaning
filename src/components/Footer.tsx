        ...
        <div className="grid sm:grid-cols-2 lg:grid-cols-4 gap-10">
          ...
          <div className="sm:col-span-2 lg:col-span-1">
            ...
            <a
              ...
              className="inline-flex items-center gap-2 px-4 py-2 bg-white/10 rounded-full hover:bg-[#1A5EA8]/30 transition-all duration-300 text-white/80 hover:text-white text-sm"
            >
          ...
          <div>
            ...
            <ul className="space-y-3">
              <li>
                <a href="tel:3302031654" className="flex items-start gap-3 text-white/80 hover:text-[#1A5EA8] transition-colors text-sm">
                  <Phone className="w-4 h-4 mt-0.5 flex-shrink-0" />
                  (330) 203-1654
                </a>
              </li>
              <li>
                <a href="mailto:info@warnerswindowcleaning.com" className="flex items-start gap-3 text-white/80 hover:text-[#1A5EA8] transition-colors text-sm">
