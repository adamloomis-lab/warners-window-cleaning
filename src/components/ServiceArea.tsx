...
export default function ServiceArea() {
  ...
  return (
    <section id="service-area" className="relative py-20 md:py-28 overflow-hidden">
      ...
      >
        <div className="w-16 h-16 rounded-2xl bg-[#FA7864]/20 flex items-center justify-center mx-auto mb-6">
          <MapPin className="w-8 h-8 text-[#FA7864]" strokeWidth={1.5} />
        </div>
        ...
        <p className="text-xl text-white/85 max-w-3xl mx-auto leading-relaxed">
          Proudly serving{" "}
          <span className="font-semibold text-[#FA7864]">
        ...
        <div ref={tagsRef} className="mt-10 flex flex-wrap justify-center gap-3">
          {cities.map((city) => (
            <a
              ...
              className="px-5 py-2.5 bg-white/10 backdrop-blur-sm border border-white/20 rounded-full text-white text-sm font-medium hover:bg-[#FA7864]/30 hover:border-[#FA7864]/50 transition-all duration-300 cursor-pointer"
            >
              {city.name}, OH
            </a>
          ))}
