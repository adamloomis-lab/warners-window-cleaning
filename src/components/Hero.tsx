...
export default function Hero() {
  return (
    ...
    >
      ...
      <div className="absolute top-20 right-20 w-32 h-32 bg-[#1A5EA8]/10 rounded-full blur-3xl animate-float hidden lg:block" />
      ...
      <div className="container relative z-10 py-16 md:py-24">
        <div className="max-w-2xl hero-animate">
          ...
          <div className="mt-9 flex flex-col sm:flex-row gap-4">
            <a
              href="#estimate"
              className="inline-flex items-center justify-center px-8 py-4 bg-[#1A5EA8] text-white font-medium rounded-full hover:bg-[#164e90] transition-all text-base hover:-translate-y-0.5"
            >
