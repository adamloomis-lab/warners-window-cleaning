...
export default function OurStory() {
  ...
  return (
    <section id="about" className="py-16 md:py-24 bg-[#FFF5E6] overflow-hidden">
      <div className="container">
        <div className="grid md:grid-cols-2 gap-10 lg:gap-16 items-center">
          {/* Left — Photos showcasing Wadsworth community */}
          <div ref={imgRef} className="relative">
            <div className="absolute -top-6 -left-6 w-full h-full bg-[#FA7864]/10 rounded-2xl -z-10 hidden md:block" />
          ...
          <div ref={textRef}>
            ...
            <div className="mt-8 flex items-center gap-4">
              <div className="w-12 h-[2px] bg-[#FA7864]" />
              <span className="text-[#FA7864] font-semibold text-sm tracking-wide uppercase">
